...
type ChordClient interface {
	...
	// FindClosestPredeceding retrieves the closet predecessor of an ID (key)
	FindClosestPredeceding(ctx context.Context, in *FindClosestPredecedingRequest, opts ...grpc.CallOption) (*FindClosestPredecedingResponse, error)
	// FindSuccessor retrieves the first successor of a node
	FindSuccessor(ctx context.Context, in *FindSuccessorRequest, opts ...grpc.CallOption) (*FindSuccessorResponse, error)
	// GetSuccessorList retrieves the successor list (maximum at maxSuccessor) of a node
	GetSuccessorList(ctx context.Context, in *GetSuccessorListRequest, opts ...grpc.CallOption) (*GetSuccessorListResponse, error)
	// Notify tells a node that the caller might be the predecessor of the target node
	Notify(ctx context.Context, in *NotifyRequest, opts ...grpc.CallOption) (*NotifyResponse, error)
	// GetPredecessor retries the predecessor of a node
...
func (c *chordClient) FindClosestPredeceding(ctx context.Context, in *FindClosestPredecedingRequest, opts ...grpc.CallOption) (*FindClosestPredecedingResponse, error) {
	out := new(FindClosestPredecedingResponse)
	err := c.cc.Invoke(ctx, "/chord.Chord/FindClosestPredeceding", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChordServer interface {
	...
	// FindClosestPredeceding retrieves the closet predecessor of an ID (key)
	FindClosestPredeceding(context.Context, *FindClosestPredecedingRequest) (*FindClosestPredecedingResponse, error)
	// FindSuccessor retrieves the first successor of a node
...
func (UnimplementedChordServer) FindClosestPredeceding(context.Context, *FindClosestPredecedingRequest) (*FindClosestPredecedingResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindClosestPredeceding not implemented")
}
...
func _Chord_FindClosestPredeceding_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindClosestPredecedingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChordServer).FindClosestPredeceding(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chord.Chord/FindClosestPredeceding",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChordServer).FindClosestPredeceding(ctx, req.(*FindClosestPredecedingRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Chord_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FindClosestPredeceding",
			Handler:    _Chord_FindClosestPredeceding_Handler,
		},
		{
